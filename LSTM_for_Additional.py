...
if __name__ == '__main__':
    # 加载数据
    dataset = pd.read_excel(r"{}\Big_Data_Work\Additional.xlsx".format(root_dir))
    ...
    # 打印模型
    model.summary()
    tf.keras.models.save_model(model,"Model_for_Additional.ckpt")
    # 预测
    ...
    print('未来一天的新增确诊人数是: ', featruePredict)
